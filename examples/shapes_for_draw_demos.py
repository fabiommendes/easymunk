...
def fill_space(space, custom_color=(255, 255, 0, 255)):
    ...
    s = easymunk.Poly([(0, -25), (30, 25), (-30, 25)], t, radius=1, body=b)
    space.add(b, s)
    ...
    b.position = (290, 500)
    t = easymunk.Transform(ty=-100)
    s = easymunk.Poly([(0, -25), (30, 25), (-30, 25)], t, radius=3, body=b)
    space.add(b, s)
    ...
    b = easymunk.Body(1, 1)
    b.position = (460, 500)
    s = easymunk.Poly([(0, -25), (30, 25), (-30, 25)], easymunk.Transform(ty=-100),
                      radius=5, body=b)
    space.add(b, s)

    b = easymunk.Body(1, 1)
    b.position = (400, 430)
    s = easymunk.Poly([(0, -50), (50, 0), (30, 50), (-30, 50), (-50, 0)],
                      easymunk.Transform(ty=-100), body=b)
    space.add(b, s)
