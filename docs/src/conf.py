# -*- coding: utf-8 -*-
#
# easymunk documentation build configuration file, created by
...
print("Documentation for Easymunk", version)
...
modindex_common_prefix = ["easymunk."]

methodindex_common_prefix = ["easymunk."]

classindex_common_prefix = ["easymunk."]
...
# html_sidebars = {'[rieta]*': ['globaltoc.html', 'relations.html', 'sourcelink.html',
# 'searchbox.html'],
#                 'easymunk*': ['globaltoc.html', 'classtoc.html', 'relations.html',
...
latex_documents = [
    ("index", "easymunk.tex", u"easymunk Documentation", u"Victor Blomqvist", "manual"),
]
...
man_pages = [("index", "easymunk", u"easymunk Documentation", [u"Victor Blomqvist"], 1)]
...
texinfo_documents = [
    (
        "index",
        "easymunk",
        u"easymunk Documentation",
        u"Victor Blomqvist/Fábio Macêdo Mendes",
        "easymunk",
